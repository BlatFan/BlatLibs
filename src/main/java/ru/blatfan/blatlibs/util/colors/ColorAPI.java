...
import ru.blatfan.blatlibs.util.colors.patterns.*;
...
public class ColorAPI {
    ...
    private static final List<Pattern> PATTERNS = Arrays.asList(new GradientPattern(), new SolidPattern(), new RainbowPattern());@Nonnull
