...
import ru.blatfan.blatlibs.bossbar.reflection.Reflection;
...
public class BossBarAPI implements API, Listener {
	 ...
	 * @param color      {@link ru.blatfan.blatlibs.bossbar.BossBarAPI.Color}
	 * @param style      {@link ru.blatfan.blatlibs.bossbar.BossBarAPI.Style}
	 * @param progress   progress (0.0 - 1.0)
	 * @param properties {@link ru.blatfan.blatlibs.bossbar.BossBarAPI.Property}
	...
	public static BossBar addBar(Collection<Player> players, BaseComponent component, Color color, Style style, float progress, int timeout, long interval, Property... properties) {
		...
		new BossBarTimer((PacketBossBar) bossBar, progress, timeout).runTaskTimer(BlatLibs.instance, interval, interval);
		return bossBar;
	}
	 ...
	 * @param component  displayed message
	 * @param color      {@link ru.blatfan.blatlibs.bossbar.BossBarAPI.Color} (1.9-only)
	 * @param style      {@link ru.blatfan.blatlibs.bossbar.BossBarAPI.Style} (1.9-only)
	 * @param progress   progress (0.0 - 1.0)
	 * @param properties {@link ru.blatfan.blatlibs.bossbar.BossBarAPI.Property} (1.9-only)
	 * @return the new {@link BossBar} instance
	...
	public void init(Plugin plugin) {
		...
		BlatLibs.instance = APIManager.getAPIHost(this);
